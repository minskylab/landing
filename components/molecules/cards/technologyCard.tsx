...
const HorizontalCard: FC<Values> = (props: Values) => {
    ...
    return (
        <CardWrapper {...props} as="div">
            <Grid debug={DEBUG_MODE} type={"grid"} colsTemplate={{ parts: 2,size:"1fr" }} rowsTemplate={{parts:2, size:"1fr"}} p={{all:"2em"}}>
                ...
                <Grid debug={DEBUG_MODE} type="flex" cols={{from:2, how:1}} rows={{from:2, how:1}} justifyContent="flex-end" alignContent="start" > 
                    <div>{props.icon} </div>
                </Grid>     
            </Grid>
        </CardWrapper>
