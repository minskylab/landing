...
const Button: FC<ButtonProps & React.StyleHTMLAttributes<any>> = (
    props: ButtonProps & React.StyleHTMLAttributes<any>
) => {
        ...
        <CustomButtom
            ...
            kind={
                newKind
                    ? newKind
                    : {
                          backgroundColor: props.style.background.toString(),
                          fontColor: props.style.color.toString(),
                          onHover: "black",
                          onHoverText: "white"
                      }
            }
